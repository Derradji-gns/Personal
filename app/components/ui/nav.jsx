    ...
    >
      ...
      >
        <div className="card-nav-top text-white absolute inset-x-0 top-0 h-[60px] flex items-center justify-between p-2 pl-[1.1rem] z-[2]">
          ...
          >
            <div
              className={`hamburger-line text-white w-[30px] h-[2px] bg-current transition-[transform,opacity,margin] duration-300 ease-linear [transform-origin:50%_50%] ${
        ...
        <div
          className={`card-nav-content absolute left-0 right-0 top-[60px] bg-black bottom-0 p-2 flex flex-col items-stretch gap-2 justify-start z-[1] ${
